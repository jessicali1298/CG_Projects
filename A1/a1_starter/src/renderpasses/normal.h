...
struct NormalPass : RenderPass {
    ...
    void render() override {
        ...
        for (auto& object : objects) {
            ...
            glBindVertexArray(object.vbo); //want to draw something w/ this object
            glDrawArrays(GL_TRIANGLES,0,object.nVerts); //draw this object with triangles
            glBindVertexArray(0); //don't worry about it, it's an internal thing, to tell the program that this has ended
